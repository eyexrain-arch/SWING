...
function toOwnUser(row) {
  return { ...toPublicUser(row), questionnaire: row.questionnaire || {} };
}
  ...
  * { box-sizing: border-box; }
  ...
  @media (max-width: 720px) {
    ...
    .mobile-nav button {
      ...
      font-size: 10.5px; font-weight: 800; color: #8a7580; position: relative;
    }
    .mobile-nav button .icon { font-size: 18px; display: flex; }
    .mobile-nav button .icon svg { width: 22px; height: 22px; stroke-width: 2.6; }
    .mobile-nav button.active { color: var(--pink-600); font-weight: 800; }
    .mobile-nav button.active .icon svg { stroke-width: 3; }
    .mobile-nav button.active:not(.mobile-nav-fab)::before {
      content: ''; position: absolute; top: 0; left: 50%; transform: translateX(-50%);
      width: 26px; height: 4px; border-radius: 0 0 4px 4px; background: var(--pink-600);
    }
    ...
    .mobile-nav-fab .icon {
      ...
      color: white; box-shadow: 0 8px 20px rgba(179,36,90,0.5), 0 0 0 6px var(--cream);
    }
    .mobile-nav-fab .icon svg { width: 24px; height: 24px; stroke-width: 2.8; }
    .mobile-nav-fab .fab-label { color: var(--pink-600); font-weight: 800; }
    .mobile-nav-fab:not(.active) .fab-label { color: #8a7580; font-weight: 700; }
...
<div id="dashboard">
  ...
  <main class="main">
    <div class="topbar">
      ...
      <div class="top-actions">
        <button class="icon-btn" onclick="logout()" aria-label="Log out" title="Log out"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M12 3v8"/><path d="M6.5 6.5a7.5 7.5 0 1 0 11 0"/></svg></button>
  ...
  <nav class="mobile-nav">
    <button class="mobile-nav-item active" data-view="discover" onclick="switchView('discover')"><span class="icon"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M3 11.5 12 4l9 7.5"/><path d="M5.5 10v9a1 1 0 0 0 1 1H9a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h2.5a1 1 0 0 0 1-1v-9"/></svg></span>Discover</button>
    <button class="mobile-nav-item" data-view="matches" onclick="switchView('matches')"><span class="icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M21 11.5a8.4 8.4 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.4 8.4 0 0 1-3.8-.9L3 21l1.9-5.7a8.4 8.4 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6A8.4 8.4 0 0 1 12.5 3h.5a8.48 8.48 0 0 1 8 8v.5Z"/></svg></span>Messages<span class="mnav-badge" id="mnav-messages-count" style="display:none;"></span></button>
    <button class="mobile-nav-item mobile-nav-fab" data-view="ai" onclick="switchView('ai')" aria-label="Swing AI"><span class="icon"><svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" stroke="none" aria-hidden="true" focusable="false"><path d="M12 2c.6 3.6 1.4 5.9 2.6 7.4 1.5 1.2 3.8 2 7.4 2.6-3.6.6-5.9 1.4-7.4 2.6-1.2 1.5-2 3.8-2.6 7.4-.6-3.6-1.4-5.9-2.6-7.4C7.9 13.4 5.6 12.6 2 12c3.6-.6 5.9-1.4 7.4-2.6C10.6 7.9 11.4 5.6 12 2Z"/></svg></span><span class="fab-label">AI</span></button>
    <button class="mobile-nav-item" data-view="likes" onclick="switchView('likes')"><span class="icon"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M12 2.5 15 9l7 .9-5.1 4.8L18.2 21 12 17.4 5.8 21l1.3-6.3L2 9.9 9 9z"/></svg></span>Likes<span class="mnav-badge" id="mnav-likes-count" style="display:none;"></span></button>
    <button class="mobile-nav-item" data-view="profile" onclick="switchView('profile')" aria-label="Profile"><span class="icon"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="8" r="3.6"/><path d="M4.5 20.5a7.5 7.5 0 0 1 15 0"/></svg></span>Profile</button>
  </nav>
</div>
