  ...
  * { box-sizing: border-box; }
  ...
  @media (max-width: 720px) {
    ...
    .mobile-nav-fab .icon {
      ...
      color: white; box-shadow: 0 6px 18px rgba(179,36,90,0.45), 0 0 0 6px var(--cream);
    }
    .mobile-nav-fab .fab-label { color: var(--pink-600); font-weight: 700; }
    .mobile-nav-fab:not(.active) .fab-label { color: var(--muted); font-weight: 500; }
