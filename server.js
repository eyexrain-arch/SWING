...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .swipe-photo { position: relative; height: clamp(420px, 65vh, 620px); background-size: cover; background-position: center; display: flex; flex-direction: column; justify-content: flex-end; }
  ...
  @media (max-width: 720px) {
    ...
    .swipe-photo { height: clamp(320px, 56vh, 500px); min-height: 0; }
