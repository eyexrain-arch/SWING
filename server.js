...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .discover-stack {
    position: relative; width: 100%; max-width: min(760px, 100%); margin: 0 auto;
  }
  ...
  .discover-carousel-card {
    flex: 0 0 250px; width: 250px; scroll-snap-align: start; scroll-snap-stop: always;
    display: flex; flex-direction: column; align-items: center; gap: 12px;
  }
  @media (max-width: 560px) {
    /* Fixed (not viewport-scaled) card width, sized so one card fills most
       of the screen and the next card's edge peeks in as a scroll cue. */
    .discover-carousel-card { flex-basis: 220px; width: 220px; }
  }
  ...
  .discover-carousel-photo .swipe-details .name-row { font-size: 19px; }
...
function scrollDiscoverCarousel(delta) {
  ...
  const amount = (card ? card.getBoundingClientRect().width : track.clientWidth) + 18;
