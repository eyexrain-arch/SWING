...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  @media (max-width: 720px) {
    ...
    body.chat-open .chat-panel { height: calc(100vh - 130px); height: calc(100dvh - 130px); }
...
<div id="dashboard">
  ...
  <nav class="mobile-nav">
    ...
    <button class="mobile-nav-item" data-view="ai" onclick="switchView('ai')"><span class="icon">✨</span>AI</button>
...
function switchView(view) {
  ...
  else if (view === 'ai') { document.getElementById('panel-ai').classList.add('visible'); renderAiChat(); }
