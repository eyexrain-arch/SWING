...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .icon-btn#profile-settings-btn { width: 42px; height: 42px; border: 1px solid var(--border); background: var(--card); color: var(--ink); border-radius: 13px; box-shadow: 0 4px 14px rgba(75,20,45,0.08); cursor: pointer; transition: transform .18s ease, box-shadow .18s ease, color .18s ease, border-color .18s ease, background .18s ease; }
  .icon-btn#profile-settings-btn svg { width: 19px; height: 19px; stroke-width: 2; transition: transform .18s ease; }
  .icon-btn#profile-settings-btn:hover { color: var(--pink-600); border-color: rgba(179,36,90,.28); background: var(--pink-100); box-shadow: 0 7px 18px rgba(75,20,45,0.12); transform: translateY(-1px); }
  .icon-btn#profile-settings-btn:hover svg { transform: rotate(18deg); }
  .icon-btn#profile-settings-btn:active { transform: translateY(0) scale(.97); }
  .icon-btn#profile-settings-btn:focus-visible { outline: 3px solid rgba(179,36,90,.18); outline-offset: 2px; }
  ...
  body.settings-dark .icon-btn#profile-settings-btn { box-shadow: 0 5px 16px rgba(0,0,0,.22); }
  body.settings-dark .icon-btn#profile-settings-btn:hover { background: var(--pink-100); border-color: rgba(255,255,255,.10); }
