...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Each slide is exactly the full width of the carousel track, so only one
     ...
     next one, rather than several cards peeking side by side.
     max-width/margin here only ever matter once the track is wider than
     480px (i.e. tablets/laptops) — on phones the track is already
     narrower than that, so this doesn't change anything there. Without
     it, the card scaled all the way up to the .discover-stack cap
     (900px), making it look oversized next to every other ~440-520px
     panel in the app on a laptop screen. */
  ...
  .discover-carousel-photo {
    width: 100%; margin: 0 auto; border-radius: 22px; overflow: hidden;
