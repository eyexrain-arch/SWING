      ...
      <div class="discover-col">
        ...
        <div class="view-panel visible" id="panel-discover">
          ...
          <div class="discover-stack-wrap">
            ...
            <div class="swipe-hint" id="discover-stack-hint" style="display:none;">Drag the card, or swipe left to pass / right to like</div>
          </div>
        </div>
...
function renderDiscoverList() {
  ...
  if (actions) actions.style.display = tab === 'maylike' && state.candidates.length ? '' : 'none';
  if (hint) hint.style.display = tab === 'maylike' && state.candidates.length ? '' : 'none';
  ...
  const visible = state.candidates.slice(0, 3);
