...
function applySwingTheme(theme) {
  document.body.classList.toggle('settings-dark', theme === 'dark');
  if (theme === 'system') {
    document.body.classList.toggle('settings-dark', window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches);
  }
