      ...
      <div class="discover-col">
        ...
        <div class="view-panel visible" id="panel-discover">
          <div class="filter-tabs discover-category-tabs" role="tablist" aria-label="Discover categories">
            <button class="active" type="button" role="tab" aria-selected="true" onclick="setDiscoverTab('maylike')" aria-label="Profiles You May Like" title="Profiles You May Like">✨</button>
            <button type="button" role="tab" aria-selected="false" onclick="setDiscoverTab('liked')" aria-label="Profiles You Liked" title="Profiles You Liked">❤️</button>
            <button type="button" role="tab" aria-selected="false" onclick="setDiscoverTab('nearby')" aria-label="Users Nearby" title="Users Nearby">📍</button>
            <button type="button" role="tab" aria-selected="false" onclick="setDiscoverTab('new')" aria-label="New Users" title="New Users">🆕</button>
          </div>
